codeunit 60101 "Custom LSC Statement-Calculate"
{
    ...
    begin
        ...
        Transaction.SetRange("Transaction Type", Transaction."Transaction Type"::Sales);//chetan
    ...
    internal procedure SetTransactionsFree(Statement: Record "LSC Statement")
    var
        TransactionStatus: Record "LSC Transaction Status";
        TransSalesEntryStatus: Record "LSC Trans. Sales Entry Status";
        RetailCommentLine: Record "LSC Retail Comment Line";
    ...
    begin
        ...
        if Transaction."Transaction Type" in
           [Transaction."Transaction Type"::Logon, Transaction."Transaction Type"::Logoff]
        then
            exit(false);
    ...
    internal procedure GetSerialLotExpDate(var pTransSalesEntry: Record "LSC Trans. Sales Entry"): Date
    var
        ItemLedgerEntry: Record "Item Ledger Entry";
        ExpDate: Date;
    begin
    ...
    internal procedure TransSalesCheckSerialNo(var pTransSalesEntry: Record "LSC Trans. Sales Entry"; var pErrorText: Text[250]): Boolean
    var
        ExpDate: Date;
        SerialNoInv: Decimal;
    ...
    begin
        ...
        // if ItemTrack.IsItemSNTracking(pTransSalesEntry."Item No.") then begin
        //     SerialNoInv := GetSerialLotNoInv(pTransSalesEntry);
    ...
    begin
        ...
        // if ItemTrack.IsItemLotTracking(pTransSalesEntry."Item No.") then begin
